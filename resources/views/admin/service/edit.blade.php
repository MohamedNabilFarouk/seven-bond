        ...
        <div class="card rounded card-form__body card-body shadow-lg">
            <form method="post" action="{{ route('service.update', $service->id) }}" enctype="multipart/form-data">
                ...
                <div class="form-group mb-10">
                    ...
                    <textarea name="des_en" class="form-control form-control-solid">{{ $service->des_en }}</textarea>
                </div>
                <div class="form-group mb-10">
                    <label for="exampleFormControlInput1" class="required form-label">Description Ar</label>
                    <textarea name="des_ar" class="form-control form-control-solid">{{ $service->des_ar }}</textarea>
                </div>
                ...
                <!-- <div class="form-group mb-10">
                    <label for="exampleFormControlInput1" class="required form-label">Icon Image </label>
                    <div class="icon btn btn-block btn-lg btn-soft-primary pe-none mb-6"> {!! $service->image !!} </div>
