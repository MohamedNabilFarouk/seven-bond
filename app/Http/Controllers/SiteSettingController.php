...
class SiteSettingController extends Controller
{
    ...
    public function generalUpdate(Request $request)
    {
        ...
        $request_data = $request->except(['_token', '_method', 'logo', 'favicon','about_image','banner_vid','technical_data_image']);
        ...
        if($request->has('technical_data_image')){
            if ($site_settings -> technical_data_image) {
                Storage::disk('public_uploads')->delete('img/technicalData/' . $site_settings -> technical_data_image);
            } // end of inner if
            $technicalDataPath = $this->saveImages( $request -> technical_data_image , 'site/img/technicalData');
            $request_data['technical_data_image'] = $technicalDataPath;
        }
